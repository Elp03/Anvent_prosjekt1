...
Prosjektet er bestående av mange forskjellige blokker.

jjshikjef


== Steinartharts-Hart kodeblokk
I LabVIEW er det mulighet for å sammle mange kodeblokker i en blokk, sånn at man kan bruke blokken igjen på mange forskellige steder.

Ved bruk av denne metoden samlet jeg hele Steinartharts-Harts formelen i en blokk. Denne tar inn variabler som den målte og utregnede $R_"thermistor"$ og returnerer temperaturen i kelvin. 
